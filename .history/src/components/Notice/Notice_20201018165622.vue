  ...
  <div class="employee">
    ...
    <el-card>
      ...
      >
        ...
        <el-table-column prop="id" label="公告名称" width="120">
          <template slot-scope="scope">{{ scope.row.name }}</template>
        </el-table-column>
        <el-table-column prop="content" label="公告内容" width="120"> </el-table-column>
        <el-table-column prop="createDate" label="创建时间" width="120">
        </el-table-column>
        <el-table-column prop="title" label="公告人" width="120"> </el-table-column>
