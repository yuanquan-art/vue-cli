  ...
  <div class="employee">
    ...
    <el-card>
      <el-row>
        职位：
        <div class="options">
          <el-select v-model="select" slot="prepend" placeholder="请选择职位">
      ...
      <el-row>
        性别：
        <div class="options">
          <el-select v-model="selectsex" slot="prepend" placeholder="请选择姓名">
        ...
        所属部门：
        <div class="options">
          <el-select v-model="selectdoor" slot="prepend" placeholder="--部门选择--">
