  ...
  width="70%"
   @close="setRightDialogClosed">
      ...
      >
        <el-row>
          <el-col :span="8">
            <el-form-item label="姓名" prop="updateUser[0].name">
              <el-input v-model="updateUser[0].name"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="身份证号码" prop="updateUser[0].cardId">
   ...
   <el-row>
          <el-col :span="8">
            <el-form-item label="政治面貌" >
              <el-input v-model="updateUser[0].party"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="QQ号码" >
              <el-input v-model="updateUser[0].qqNum"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
		<el-row>
          <el-col :span="8">
            <el-form-item label="联系地址" >
              <el-input v-model="updateUser[0].address"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="邮政编码" >
              <el-input v-model="updateUser[0].postCode"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
		...
		<el-row>
          <el-col :span="8">
            <el-form-item label="出生日期" >
              <el-input v-model="updateUser[0].birthday"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="民族">
              <el-input v-model="updateUser[0].race"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
		...
		<el-row>
          <el-col :span="8">
            <el-form-item label="所学专业" >
              <el-input v-model="updateUser[0].speciality"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="爱好">
              <el-input v-model="updateUser[0].hobby"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
		...
		<el-row>
          <el-col :span="8">
            <el-form-item label="备注" >
              <el-input v-model="updateUser[0].remark"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
			  所属部门：
