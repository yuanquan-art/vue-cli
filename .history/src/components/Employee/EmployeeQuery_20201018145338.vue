<template>
 ...
 <el-dialog
  ...
  <span slot="footer" class="dialog-footer">
    <el-button @click="dialogVisible = empolyeeDialogVisible">取 消</el-button>
    <el-button type="primary" @click="dialogVisible = empolyeeDialogVisible">确 定</el-button>
  </span>
</el-dialog>
  </div>
...
export default {
  ...
  methods: {
   ...
   async  update(row) {
        ...
        console.log(this.empolyeeDialogVisible)
      //   const { data: res } = await this.$http.post(
